...
<!--车系名称 end-->
<div id="body">
    <form action="<?=URL?>iscaradmin/?p=carstyles&a=add" method="post" enctype="multipart/form-data" onsubmit="return verify()">
        ...
        <table width="100%" style="line-height: 18px;">
            ...
            <tr>
                <td>
                    <input type="text" class="inline form-control" disabled="disabled" id="carmodels_v" style="width: 150px;" >
                </td>
                <input type="hidden" id="carmodels" name="cm_id">
            </tr>
        </table>
        <div>
            <div style="width: 500px">
                <label><?=$lang_carstyles['车款名称']?>:</label>
                <input type="text" class="inline form-control " name="cs_fullname"  required>
            </div>
            <div style="width: 300px">
                <label><?=$lang_carstyles['车款昵称']?>:</label>
                <input type="text" class="inline form-control " name="cs_nickname"   >
            </div>
        </div>
        <div>
            <div style="width: 200px">
                <label><?=$lang_carstyles['缩写']?>:</label>
                <input type="text" class="inline form-control " name="cs_short_name"  >
            </div>
<!--            <div style="width: 100px">-->
<!--                <label>--><?//=$lang_carstyles['序号']?><!--:</label>-->
<!--                <input type="text" id="list" class="inline form-control " name="cs_list_order"  onblur="validate_num(this)" maxlength="8">-->
<!--            </div>-->
        </div>
        ...
        <div>
            ...
            <span class="radio-inline">
                <input type="radio" name="cs_hot_item_tag" value="3"> <?/*=$lang_carstyles['是']*/?>
            </span>
            <span class="radio-inline">
                <input type="radio" name="cs_hot_item_tag" value="1"> <?/*=$lang_carstyles['否']*/?>
            </span>-->
    ...
    function verify() {
        ...
        if (!$.trim(cb)){
            ...
            $.ajax({
                ...
                type: 'post',
                async: false,
                data: {'cs_name': cs_name, 'a': 'verify_cs_name', 'cb_id' : cb_id, 'cm_id':cm_id},
                dataType: 'json',
                error: function () {
