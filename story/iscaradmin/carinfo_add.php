  ...
  <span class="input-group-btn">
    ...
    <div class="" style="padding: 10px;">
        <label class="radio-inline" v-for="item in post" style="margin-top: 20px;">
            <input type="radio" name="ci_manufactory"  value="{{item.keyword}}"><span>{{item.value}}</span >
        </label>
    </div>
</div>
<!--制造商 end-->
...
<div class="ci_carsource" style="display: none;" id="carsour">
  ...
  <span class="input-group-btn">
    ...
    <div class="" style="padding: 10px;">
        <label class="radio-inline" v-for="item in post" style="margin-top: 20px;">
            <input type="radio" name="ci_carsource"  value="{{item.keyword}}"><span>{{item.value}}</span >
        </label>
    </div>
</div>
<!--产地 end-->
...
<div class="ci_technical_cooperation" style="display: none;" id="technical">
  ...
  <span class="input-group-btn">
    ...
    <div class="" style="padding: 10px;">
        <label class="radio-inline" v-for="item in post" style="margin-top: 20px;">
            <input type="radio" name="ci_technical_cooperation"  value="{{item.keyword}}"><span >{{item.value}}</span >
        </label>
    </div>
</div>
<!--技术合作 end-->
...
<div class="ci_car_bodytype" style="display: none;" id="bodytype">
  ...
  <span class="input-group-btn">
    ...
    <div class="" style="padding: 10px;">
        <label class="radio-inline" v-for="item in post" style="margin-top: 20px;">
            <input type="radio" name="ci_car_bodytype"  value="{{item.cbt_id}}"><span >{{item.cbt_fullname}}</span >
        </label>
    </div>
</div>
<!--车身分类 end-->
...
<div class="ci_distribution_agent" style="display: none;" id="dist_age">
  ...
  <span class="input-group-btn">
    ...
    <div class="dis_a" style="padding: 10px;">
        <label class="radio-inline" v-for="item in post" style="margin-top: 20px;">
            <input type="checkbox"  name="ci_distribution_agent"  :value="item.keyword"><span>{{item.value}}</span >
        </label>
    </div>
</div>
<!--经销商/代理商 end-->
...
<div class="ci_car_equiptments" style="display: none;" id="car_equip">
  ...
  <span class="input-group-btn">
    ...
    <div class="car_e" style="padding: 10px;">
        <label class="radio-inline" v-for="item in post" style="margin-top: 20px;">
            <input type="checkbox" name="ci_car_equiptments"  value="{{item.keyword}}"><span >{{item.value}}</span >
        </label>
    </div>
</div>
<!--车辆配备 end-->
...
<button class="btn btn-default" type="button" id="model_s"><?=$lang_carinfo['搜索']?></button>
    ...
    <div class="" style="padding: 10px;">
        <label class="radio-inline" v-for="item in post" style="margin-top: 20px;">
            <input type="radio" name="car_models"  value="{{item.cm_id}}"><span>{{item.cm_fullname}}</span >
        </label>
    </div>
</div>
<!--汽车车型 end-->
...
<button class="btn btn-default" type="button" id="style_s"><?=$lang_carinfo['搜索']?></button>
    ...
    <div class="" style="padding: 10px;">
        <label class="radio-inline" v-for="item in post" style="margin-top: 20px;">
            <input type="radio" name="car_styles"  value="{{item.cs_id}}"><span>{{item.cs_fullname}}</span >
        </label>
    </div>
</div>
<!--车款分类 end-->
<div id="body">
    <form id="form" action="<?=URL?>iscaradmin/?p=carinfo&a=add" method="post" enctype="multipart/form-data" onsubmit="return verify_order()">
        <table width="100%" style="line-height: 18px;">
            ...
            <tr>
                <td>
                    <input type="text" class="inline form-control" disabled="disabled" id="carbrands_v" style="width: 200px;" >
                </td>
                <input type="hidden" id="carbrands" name="ci_car_brand">
                <td>
                    <input type="text" class="inline form-control" disabled="disabled" id="carmodels_v" style="width: 200px;" >
                </td>
                <input type="hidden" id="carmodels" name="ci_brand_model">
                <td><input type="text" class="inline form-control" disabled="disabled" id="car_bodytype_v" style="width: 200px;" ></td>
                <input type="hidden" id="car_bodytype" name="ci_car_bodytype">
            </tr>
        </table>
        <table width="100%" style="line-height: 18px;margin-top: 20px;">
            ...
            <tr>
                <td>
                    <input type="text" class="inline form-control" disabled="disabled" id="carstyles_v" style="width: 580px;" >
                </td>
                <input type="hidden" id="carstyles" name="ci_model_style">
            </tr>
        </table>
        <table width="100%" style="line-height: 18px;" class="mt">
            ...
            <tr>
                <td><input type="text" class="inline form-control "id="search_box_key" onkeyup="searchShow()" onblur="fill()" name="ci_article_title"  autocomplete="off"  style="width: 500px;">
                ...
                <td><input type="text" class="inline form-control " name="ci_car_year_style"  onblur="validate_num(this)"  onchange="validate_submit(this)" maxlength="4" style="width: 300px;" required></td>
            </tr>
        </table>
        <table width="100%" style="line-height: 18px;" class="mt">
            <tr>
            ...
            <tr>
                <td><input type="text" class="inline form-control " name="ci_car_seats"  onblur="validate_num(this)"  onchange="validate_submit(this)" maxlength="2" style="width: 150px;"></td>
                <td><input type="text" class="inline form-control " name="ci_car_doors"  onblur="validate_num(this)"  onchange="validate_submit(this)" maxlength="2" style="width: 150px;"></td>
                <td><input type="text" class="inline form-control " name="ci_sale_price"  onblur="validate_num(this)"  onchange="validate_submit(this)" maxlength="8" style="width: 150px;"></td>
                <td><input type="text" class="inline form-control " name="ci_overall_length"  onblur="validate_num(this)"  onchange="validate_submit(this)" maxlength="8" style="width: 150px;"></td>
            </tr>
            <tr>
            ...
            <tr>
                <td><input type="text" class="inline form-control " name="ci_overall_width"  onblur="validate_num(this)"  onchange="validate_submit(this)" maxlength="8" style="width: 150px;"></td>
                <td><input type="text" class="inline form-control " name="ci_overall_height"  onblur="validate_num(this)"  onchange="validate_submit(this)" maxlength="8" style="width: 150px;"></td>
                <td><input type="text" class="inline form-control " name="ci_overall_weight"  onblur="validate_num(this)"  onchange="validate_submit(this)" maxlength="8" style="width: 150px;"></td>
                <td><input type="text" class="inline form-control " name="ci_wheel_base"  onblur="validate_num(this)"  onchange="validate_submit(this)" maxlength="8" style="width: 150px;"></td>
            </tr>
            <tr>
            ...
            <tr>
                <td><input type="text" class="inline form-control " name="ci_rear_track" maxlength="8" onblur="validate_num(this)"  onchange="validate_submit(this)"  style="width: 150px;"></td>
                <td><input type="text" class="inline form-control " name="ci_front_track" maxlength="8" onblur="validate_num(this)"  onchange="validate_submit(this)"  style="width: 150px;"></td>
                <td><input type="text" class="inline form-control " name="ci_luggage_capacity" maxlength="8" onblur="validate_num(this)"  onchange="validate_submit(this)"  style="width: 150px;"></td>
                <td><input type="text" class="inline form-control " name="ci_turning_radius" maxlength="8" onblur="validate_num(this)"  onchange="validate_submit(this)"  style="width: 150px;"></td>
            </tr>
            <tr>
            ...
            <tr>
                <td><input type="text" class="inline form-control " name="ci_front_wheel_size" maxlength="15" style="width: 150px;"></td>
                <td><input type="text" class="inline form-control " name="ci_rear_wheel_siae" maxlength="15" style="width: 150px;"></td>
                <td><input type="text" class="inline form-control " name="ci_aerodynamic_drag" maxlength="10" style="width: 150px;"></td>
                <td><input type="text" class="inline form-control " name="ci_ground_clearance" maxlength="8" onblur="validate_num(this)"  onchange="validate_submit(this)"  style="width: 150px;"></td>
            </tr>
            <tr>
            ...
            <tr>
                <td><input type="text" class="inline form-control " name="ci_tank_capacity" maxlength="8" onblur="validate_num(this)"  onchange="validate_submit(this)"  style="width: 150px;"></td>
                <td>
                    <select class="form-control" style="width: 150px" name="ci_steering_system" >
                        ...
                        <?php foreach($terms_sts as $v):?>
                            <option value="<?=$v['keyword']?>"><?=$v['value']?></option>
                        <?php endforeach;?>
                    </select>
                </td>
                <td>
            ...
            <tr>
                ...
                <td><input type="text" class="inline form-control " name="ci_battery_capacity"  onblur="validate_num(this)"  onchange="validate_submit(this)" maxlength="8" style="width: 150px;"></td>
                <td>
                ...
                <td><input type="text" class="inline form-control " name="ci_max_milage"  onblur="validate_num(this)"  onchange="validate_submit(this)" maxlength="8" style="width: 150px;"></td>
            </tr>
            <tr>
            ...
            <tr>
                <td><input type="text" class="inline form-control " name="ci_recharge_time"  onblur="validate_num(this)"  onchange="validate_submit(this)" maxlength="8" style="width: 150px;"></td>
                <td><input type="text" class="inline form-control " name="ci_urban_consumption"  onblur="validate_num(this)"  onchange="validate_submit(this)" maxlength="5" style="width: 150px;"></td>
                <td><input type="text" class="inline form-control " name="ci_high_speed_consumption"  onblur="validate_num(this)"  onchange="validate_submit(this)" maxlength="5" style="width: 150px;"></td>
                <td><input type="text" class="inline form-control " name="ci_average_consumption"  onblur="validate_num(this)"  onchange="validate_submit(this)" maxlength="5" style="width: 150px;"></td>
            </tr>
            <tr>
            ...
            <tr>
                <td><input type="text" class="inline form-control " name="ci_displacement"  onblur="validate_num(this)"  onchange="validate_submit(this)" maxlength="8" style="width: 150px;"></td>
                <td><input type="text" class="inline form-control " name="ci_compression_ratio"  maxlength="15"  style="width: 150px;"></td>
                <td>
            ...
            <tr>
                ...
                <td><input type="text" class="inline form-control " name="ci_valve_each_cylinder"  onblur="validate_num(this)"  onchange="validate_submit(this)" maxlength="8" style="width: 150px;"></td>
                <td><input type="text" class="inline form-control " name="ci_total_valves"  onblur="validate_num(this)"  onchange="validate_submit(this)" maxlength="8" style="width: 150px;"></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" class="inline form-control " name="ci_max_horsepower"  maxlength="15"  style="width: 150px;"></td>
                <td><input type="text" class="inline form-control " name="ci_max_torque"  maxlength="15"  style="width: 150px;"></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" class="inline form-control" disabled="disabled" id="manufactory_v" style="width: 150px;" ></td>
                <input type="hidden" id="manufactory" name="ci_manufactory">
            </tr>
            <tr>
            ...
            <tr>
                <td><input type="text" class="inline form-control" disabled="disabled" id="carsource_v" style="width: 150px;" ></td>
                <input type="hidden" id="carsource" name="ci_carsource">
                <td><input type="text" class="inline form-control" disabled="disabled" id="technical_cooperation_v" style="width: 150px;" ></td>
                <input type="hidden" id="technical_cooperation" name="ci_technical_cooperation">
                <td><input type="text" class="inline form-control " name="ci_html_descript"    style="width: 150px;"></td>
                <td><input type="text" class="inline form-control " name="ci_car_video_link"    style="width: 150px;"></td>
            </tr>
            <tr>
...
<!--                <td><label>--><?//=$lang_carinfo['车部件安装位置']?><!--:</label></td>-->
            ...
            <tr>
                <td><input type="text" class="inline form-control " name="ci_web_address"    style="width: 150px;"></td>
                <td><input type="text" class="inline form-control " name="ci_fuel_tax"  maxlength="8" onblur="validate_num(this)"  onchange="validate_submit(this)" style="width: 150px;"></td>
                <td><input type="text" class="inline form-control " name="ci_license_tax" maxlength="8" onblur="validate_num(this)"  onchange="validate_submit(this)"  style="width: 150px;"></td>
<!--                <td>-->
...
<!--                <td><label>--><?//=$lang_carinfo['气缸名称']?><!--:</label></td>-->
            ...
            <tr>
<!--                <td><input type="text" class="inline form-control " name="cp_part_name"    style="width: 150px;"></td>-->
<!--                <td>-->
...
<!--                </td>-->
            ...
            <table width="100%" style="line-height: 18px;margin-top: 10px;">
                ...
                <tr>
                    <td><input type="text" class="inline form-control " name="tag_id"  style="width: 300px;"></td>
                </tr>
            </table>
            <table width="100%" style="line-height: 18px;">
                <tr>
                ...
                <tr>
                    <td>
                        <div class="input-group" style="width: 600px;">
                            ...
                            <ul id="ul_pics"  class="ul_pics"></ul>
                        <ul id="meta_id"></ul>
                    </td>
                </tr>
            </table>
                ...
                <tr>
                    <td>
                        <div class="input-group" style="width: 600px;">
                            ...
                            <ul id="other_ul_pics" class="ul_pics "></ul>
            ...
            <table width="100%" style="line-height: 18px;margin-top: 50px;">
                ...
                <tr>
                    <td>
                        ...
                        <ul id="other_interior_ul_pics" class="ul_pics "></ul>
        ...
        <div class="mt">
            ...
            <span class="radio-inline">
                <input type="radio" name="ci_recommend" value="2"> <?=$lang_carinfo['是']?>
            </span>
            <span class="radio-inline">
                <input type="radio" name="ci_recommend" value="1"> <?=$lang_carinfo['否']?>
            </span>
...
<script>
    ...
    function verify_order(){
        ...
        var tag= $('input:radio[name="ci_recommend"]:checked').val();
        ...
        if (!$.trim(cb)){
            ...
            layer.msg('<?=$lang_carinfo['是否推荐不能为空']?>' ,{icon:2});
            bool = false;
        }
    ...
    function ajax_get(s,v,r,e,a,b) {
        ...
        $.ajax({
            ...
            type:'post',
            data:{'search':e,'cb_id':a, 'cm_id':b, 'reg':r},
            dataType:'html',
            error: function(){
                alert('Error loading document');
            },
    ...
    var uploader = new plupload.Uploader({//创建实例的构造方法
        ...
        init: {
            ...
            FileUploaded: function (up, file, info) { //文件上传成功的时候触发
                ...
                $("#" + file.id).html("<div class='img layer-photos-demo'><img src='" + data.pic + "' alt='"+data.name+"'/></div><a class='glyphicon glyphicon-trash remove' style='margin-top: 10px;'></a><br><input type='hidden' name='meta_id[]' value='" + data.meta_id + "'><input class='order' type='text' name='order_id[]' value='0'>");
            },
    ...
    var uploader_other = new plupload.Uploader({//创建实例的构造方法
        ...
        init: {
            ...
            FileUploaded: function (up, file, info) { //文件上传成功的时候触发
                var data = eval("(" + info.response + ")");
                $("#" + file.id).html("<div class='img layer-photos-demo'><img src='" + data.pic + "'/></div><a class='glyphicon glyphicon-trash remove' style='margin-top: 10px;'></a><br><input type='hidden' name='meta_id[]' value='" + data.meta_id + "'><input class='order_oth' type='text' name='order_id[]' value='0'>");
            },
            Error: function (up, err) { //上传出错的时候触发
                layer.msg(err.message, {icon: 5});
            }
