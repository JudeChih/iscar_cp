...
//if(is_super_admin()) {
    switch($_COOKIE['region']){
		case '':
			include_once('../iscaradmin/lang/chs/lang_menu.php');//简体中文
			break;
		case 1:
			include_once('../iscaradmin/lang/chg/lang_menu.php');//港式中文
			break;
		case 2:
			include_once('../iscaradmin/lang/cht/lang_menu.php');//台式中文
			break;
		case 3:
			include_once('../iscaradmin/lang/chs/lang_menu.php');//简体中文
			break;
	}
    $menu[90] = array(__('CarPricing'), 'read', '../iscaradmin/?p=carbrands', '', 'menu-top menu-icon-dashboard', 'menu-cars', 'dashicons-dashboard');
	$submenu['../iscaradmin/?p=carbrands'][15] = array(__($lang_menu['厂牌管理']), 'read', '../iscaradmin/?p=carbrands');
    $submenu['../iscaradmin/?p=carbrands'][10] = array(__($lang_menu['车系管理']), 'read', '../iscaradmin/?p=carmodels');
    $submenu['../iscaradmin/?p=carbrands'][20] = array(__($lang_menu['车款管理']), 'read', '../iscaradmin/?p=carstyles');
    $submenu['../iscaradmin/?p=carbrands'][25] = array(__($lang_menu['车身管理']), 'read', '../iscaradmin/?p=carbodytypes');
    $submenu['../iscaradmin/?p=carbrands'][30] = array(__($lang_menu['汽车信息管理']), 'read', '../iscaradmin/?p=carinfo');
    $submenu['../iscaradmin/?p=carbrands'][40] = array(__($lang_menu['汽车文章管理']), 'read', '../iscaradmin/?p=cararticle');
    $submenu['../iscaradmin/?p=carbrands'][50] = array(__($lang_menu['用户日志']), 'read', '../iscaradmin/?p=mylogs');
    $submenu['../iscaradmin/?p=carbrands'][60] = array(__($lang_menu['用户收藏']), 'read', '../iscaradmin/?p=myfavorite');
    $submenu['../iscaradmin/?p=carbrands'][70] = array(__($lang_menu['预设参数设置']), 'read', '../iscaradmin/?p=carterms');
//    $submenu['../iscaradmin/?p=carbrands'][70] = array(__('预设参数设置'), 'manage_options', '../iscaradmin/?p=carterms');
...
////$myrole = get_role('administrator');
//if ( is_super_admin() ) {
////    var_dump(get_role('editor'));
////    var_dump($wp_roles);
//    $menu[90] = array(__('车系管理'), 'read', '../iscaradmin/?p=carmodels', '', 'menu-top menu-icon-post', 'menu-quick-setting', 'div');
//    $menu[91] = array(__('厂牌管理'), 'read', '../iscaradmin/?p=carbrands', '', 'menu-top menu-icon-post', 'menu-quick-setting', 'div');
//    $menu[92] = array(__('车款管理'), 'read', '../iscaradmin/?p=carstyles', '', 'menu-top menu-icon-post', 'menu-quick-setting', 'div');
//    $menu[93] = array(__('车身管理'), 'read', '../iscaradmin/?p=carbodytypes', '', 'menu-top menu-icon-post', 'menu-quick-setting', 'div');
//    $menu[94] = array(__('汽车信息管理'), 'read', '../iscaradmin/?p=carinfo', '', 'menu-top menu-icon-post', 'menu-quick-setting', 'div');
//    $menu[95] = array(__('汽车文章管理'), 'read', '../iscaradmin/?p=cararticle', '', 'menu-top menu-icon-post', 'menu-quick-setting', 'div');
//    $menu[96] = array(__('用户日志'), 'read', '../iscaradmin/?p=mylogs', '', 'menu-top menu-icon-post', 'menu-quick-setting', 'div');
//    $menu[97] = array(__('用户收藏'), 'read', '../iscaradmin/?p=myfavorite', '', 'menu-top menu-icon-post', 'menu-quick-setting', 'div');
//    $menu[98] = array(__('预设参数设置'), 'read', '../iscaradmin/?p=carterms', '', 'menu-top menu-icon-post', 'menu-quick-setting', 'div');
//    $menu[99] = array('', 'read', 'separator-last', '', 'wp-menu-separator');
//}
