...
$menu[89] = array( '', 'read', 'separator2', '', 'wp-menu-separator' );
//
//// Newsletter
//$menu[90] = array(__('Newsletter'), 'edit_posts', 'newsletter.php', '', 'menu-top menu-icon-page', 'menu-newsletter', 'div' );
//	$submenu['newsletter.php'][5] = array(_x('Newsletter', 'settings screen'), 'manage_options', 'newsletter.php');
//	$submenu['newsletter.php'][10] = array(__('Email List', 'settings screen'), 'manage_options', 'email_list.php');
//	$submenu['newsletter.php'][15] = array(__('Email Group'), 'manage_options', 'options-writing.php');
// $menu[89] = array( '', 'read', 'separator2', '', 'wp-menu-separator' );
